...
def keyboard_select_action_keys_manager() -> InlineKeyboardMarkup:
    ...
    button_5 = InlineKeyboardButton(text='Комплект', callback_data='get_complect')
...
def keyboard_select_action_keys_admin() -> InlineKeyboardMarkup:
    ...
    button_6 = InlineKeyboardButton(text='Комплект', callback_data='get_complete')
    keyboard = InlineKeyboardMarkup(inline_keyboard=[[button_1], [button_3], [button_2], [button_4], [button_6],
                                                     [button_5]],)
    return keyboard
